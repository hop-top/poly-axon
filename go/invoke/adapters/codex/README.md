...
`mappings.go`; the parity table in `invoke/README.md` is built from it.
...
- [`invoke/README.md`](../../README.md): parity matrices, shim catalog, universal `Config` keys
