...
type OptionMapping struct {
	...
	Support   MappingSupport `json:"support"`
...
type ToolCapability struct {
	...
	Transcript   TranscriptSupport `json:"transcript"`
...
type InvocationAdapter interface {
	...
	// regenerate-on-build parity README at invoke/README.md is
	// built from these slices (see spec §15.8).
